function simulate_coevolution_or_evolution(
    current_inc,
    p_current_sp,
    a_current_sp,
    p_nonint_sp,
    ...
    if sum(current_inc) !== 0
        ...
        z_p, z_a, q_m = simulate_coevolution(
            f,
            z,
            alpha,
            m,
...
function update_patch_sequentially(
    n,
    k,
    x_state,
    z_p,
    ...
    for j = 1:n
        for i = 1:n
            ...
            x_p, z_p = resource_extinctions_and_colonisations(
                n_p,
                x_p_old,
                i,
                j,
            ...
            x_a, z_a = consumer_extinctions_and_colonisations(
                n_a,
                x_a_old,
                i,
                j,
            ...
            current_inc, p_nonint_sp, a_nonint_sp =
                update_grid_after_colonisation_extinction(
                    M_inc,
                    p_current_sp,
                    a_current_sp,
                )
            ...
            z_p, z_a = simulate_coevolution_or_evolution(
                current_inc,
                p_current_sp,
                a_current_sp,
                p_nonint_sp,
...
function store_and_write_results(
    n_p,
    x_p,
    n_a,
    x_a,
...
function iterate_model_until_steady_state(
    tmax,
    x_p,
    x_a,
    z_p,
    ...
    for g = 2:(tmax+1)
        ...
        # update each patch sequentially
        x_p, z_p, x_a, z_a = update_patch_sequentially(
            n,
            k,
            x_state,
            z_p,
        ...
        df_ab_traits_p = calculate_global_abundance_and_traits_and_store(
            x_p,
            z_p,
            n_patch,
            n_p,
        ...
        df_ab_traits_a = calculate_global_abundance_and_traits_and_store(
            x_a,
            z_a,
            n_patch,
            n_a,
